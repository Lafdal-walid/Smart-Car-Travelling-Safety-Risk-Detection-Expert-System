...
function displayResults(results) {
    ...
    if (!results || !results.risk_level) {
        results = { risk_level: 'low', risk_explanations: [], recommendations: [t.no_result] };
    }
    ...
    const recommendations = results.recommendations || [results.recommendation] || [t.no_result];
    const recommendationText = recommendations.length > 1 
